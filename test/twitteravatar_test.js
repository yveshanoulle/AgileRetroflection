  ...
  it('parses the result from twitter correctly', (done) => {
    ...
    twitteravatar(twitterAPI, JSON.stringify(questions)).extractUrlsFromRaw(JSON.stringify(twitterusers), (err, result) => {
      expect(result).to.eql({
        '@leiderleider': {
          'imageURL': 'http://pbs.twimg.com/profile_images/1788222780/AndreasPlayfulWithRibbon_normal.jpg',
          'realname': 'Leider\'s real name'
        },
        '@retroflection': {
          'imageURL': 'http://pbs.twimg.com/profile_images/604221243/3949464231_7c7531f034_normal.jpg',
